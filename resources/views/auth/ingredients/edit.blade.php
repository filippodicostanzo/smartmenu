        ...
        <div class="col-lg-12 margin-tb">
            <div class="card card-mini">
                ...
                <div class="card-body">
                    ...
                    {!! Form::model($item, ['method' => 'PATCH','route' => ['ingredients.update', $item->id_code], 'enctype' => 'multipart/form-data'] ) !!}
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="user_id">
                                    ...
                                    @foreach($users as $user)
                                        <option
                                            value="{{ $user->id }}" {{ $item->user_id == $user->id ? 'selected="selected"' : '' }}>
                                            {{ $user->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select id="allergens-selected" multiple="multiple" name="allergens[]">
                                    @foreach($array as $arr)
                                        <option
                                            value="{{$arr->id_code}}" {{!isset($arr->selected) ? 'selected="selected"' : '' }}>
                                            {{$arr->name_it}}
                                        </option>
                                    @endforeach
                                </select>
