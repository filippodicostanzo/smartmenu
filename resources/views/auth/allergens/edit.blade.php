            ...
            <div class="card card-mini">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        {!! Form::model($item, ['method' => 'PATCH','route' => ['allergens.update', $item->id_code], 'enctype' => 'multipart/form-data'] ) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="form-group">
                                <label for="name">Initials En</label>
                                {!! Form::text('initials_en', null, array('placeholder' => 'Initials En','class' => 'form-control')) !!}
                            </div>
                        </div>

                        <div class="col-xs-6 col-md-4">
                            <div class="form-group">
                                <label for="name">Initials It</label>
                                {!! Form::text('initials_it', null, array('placeholder' => 'Initials It','class' => 'form-control')) !!}
                            </div>
                        </div>
