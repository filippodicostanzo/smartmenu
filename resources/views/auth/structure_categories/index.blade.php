            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-action">
                        <a href="{{ route('structure_categories.create') }}">
                                    ...
                                    <td align="right">
                                        <div class="btn-group">
                                            <a class="btn btn-default btn-xs"
                                               href="{{ route('structure_categories.show',$item->id_code) }}">
                                                <i class="fas fa-eye fa-1x fa-lg" aria-hidden="true"></i>
                                            </a>
                                            <a class="btn btn-default btn-xs"
                                               href="{{ route('structure_categories.edit', $item->id_code) }}">
                                                <i class="fas fa-pencil-alt fa-1x fa-lg" aria-hidden="true"></i>
                                            </a>
                                            {!! Form::open(['method' => 'DELETE','route' => ['structure_categories.destroy', $item->id_code],'style'=>'display:inline']) !!}
