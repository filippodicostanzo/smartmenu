        ...
        <div class="col-lg-12 margin-tb">
            <div class="card card-mini">
                ...
                <div class="card-body">
                    ...
                    {!! Form::model($item, ['method' => 'PATCH','route' => ['item_categories.update', $item->id_code], 'enctype' => 'multipart/form-data'] ) !!}

                        {{ Form::hidden('fields_selected', $item->fields, array('id' => 'fields_selected')) }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Ingredienti
                                <input type="checkbox" name="fields[]" value="ingredients">
                        ...
                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Allergeni
                                <input type="checkbox" name="fields[]" value="allergens">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        ...
                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Caratteristiche
                                <input type="checkbox" name="fields[]" value="features">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        ...
                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Format
                                <input type="checkbox" name="fields[]" value="format">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        ...
                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Cantina
                                <input type="checkbox" name="fields[]" value="winery">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        ...
                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Tipologia di Vino
                                <input type="checkbox" name="fields[]" value="winetype">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        ...
                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">DOC
                                <input type="checkbox" name="fields[]" value="winedoc">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        ...
                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Vol %
                                <input type="checkbox" name="fields[]" value="vol">
                                <span class="checkmark"></span>
                            </label>
                        </div>
