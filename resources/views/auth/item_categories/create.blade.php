        ...
        <div class="col-lg-12 margin-tb">
            <div class="card card-mini">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(array('route' => 'item_categories.store','method'=>'POST', 'enctype' => 'multipart/form-data')) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Ingredienti
                                <input type="checkbox" name="fields[]" value="ingredients" checked>
                                <span class="checkmark"></span>
                            </label>
                        </div>

                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Allergeni
                                <input type="checkbox" name="fields[]" value="allergens" checked>
                                <span class="checkmark"></span>
                            </label>
                        </div>

                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Caratteristiche
                                <input type="checkbox" name="fields[]" value="features" checked>
                                <span class="checkmark"></span>
                            </label>
                        </div>

                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Format
                                <input type="checkbox" name="fields[]" value="format" checked>
                                <span class="checkmark"></span>
                            </label>
                        </div>

                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Cantina
                                <input type="checkbox" name="fields[]" value="winery" checked>
                                <span class="checkmark"></span>
                            </label>
                        </div>

                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Anno
                                <input type="checkbox" name="fields[]" value="year" checked>
                                <span class="checkmark"></span>
                            </label>
                        </div>

                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Tipologia di Vino
                                <input type="checkbox" name="fields[]" value="winetype" checked>
                                <span class="checkmark"></span>
                            </label>
                        </div>

                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">DOC
                                <input type="checkbox" name="fields[]" value="winedoc" checked>
                                <span class="checkmark"></span>
                            </label>
                        </div>

                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Region
                                <input type="checkbox" name="fields[]" value="region" checked>
                                <span class="checkmark"></span>
                            </label>
                        </div>

                        <div class="col-xs-6 col-md-3">
                            <label class="label-container" for="scales">Vol %
                                <input type="checkbox" name="fields[]" value="vol" checked>
                                <span class="checkmark"></span>
                            </label>
                        </div>
