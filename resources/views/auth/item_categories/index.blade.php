                                    ...
                                    <td align="right">
                                        <div class="btn-group">
                                            <a class="btn btn-default btn-xs"
                                               href="{{ route('item_categories.show',$item->id_code) }}">
                                                <i class="fas fa-eye fa-1x fa-lg" aria-hidden="true"></i>
                                            </a>

                                            @if(Auth::user()->hasRole('superadministrator'))
                                                <a class="btn btn-default btn-xs"
                                                   href="{{ route('item_categories.edit', $item->id_code) }}">
                                                    <i class="fas fa-pencil-alt fa-1x fa-lg" aria-hidden="true"></i>
                                                </a>
                                                {!! Form::open(['method' => 'DELETE','route' => ['item_categories.destroy', $item->id_code],'style'=>'display:inline']) !!}
