        ...
        <div class="col-lg-12 margin-tb">
            <div class="card card-mini">
                ...
                <div class="card-body">
                    ...
                    {!! Form::model($item, ['method' => 'PATCH','route' => ['menus.update', $item->id_code], 'enctype' => 'multipart/form-data'] ) !!}

                    {{ Form::hidden('items-checked', $item->items, array('id' => 'items-checked')) }}
                        ...
                        <div class="col-xs-6 col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="price_view">
                                    <option value="">--- Scegli ---</option>
                                    <option
                                        value="show_price" {{ $item->price_view == 'show_price' ? 'selected="selected"' : '' }}>
                                        Vedi Prezzi
                                    </option>
                                    <option
                                        value="hide_price" {{ $item->price_view == 'hide_price' ? 'selected="selected"' : '' }}>
                                        Nascondi Prezzi
                                    </option>
                                </select>
                            </div>
