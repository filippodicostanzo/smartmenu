                                    ...
                                    <td align="right">
                                        <div class="btn-group">
                                            <a class="btn btn-default btn-xs"
                                               href="{{ route('features.show',$item->id_code) }}">
                                                <i class="fas fa-eye fa-1x fa-lg" aria-hidden="true"></i>
                                            </a>

                                            @if(Auth::user()->hasRole('superadministrator'))
                                                <a class="btn btn-default btn-xs"
                                                   href="{{ route('features.edit', $item->id_code) }}">
                                                    <i class="fas fa-pencil-alt fa-1x fa-lg" aria-hidden="true"></i>
                                                </a>
                                                {!! Form::open(['method' => 'DELETE','route' => ['features.destroy', $item->id_code],'style'=>'display:inline']) !!}
