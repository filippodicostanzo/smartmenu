        ...
        <div class="col-lg-12 margin-tb">
            <div class="card card-mini">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(array('route' => 'structures.store','method'=>'POST', 'enctype' => 'multipart/form-data')) !!}
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="town_id">
                                    ...
                                    @foreach($towns as $town)
                                        <option value="{{$town->id_code}}">{{$town->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id">
                                    ...
                                    @foreach($categories as $cat)
                                        <option value="{{$cat->id_code}}">{{$cat->name_it}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-6 col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::checkbox('sponsored',1, false, array('class' => 'form-control')) !!}
                            </div>
                        </div>
                    </div>
